...
function ABTest(ctx) {
  ...
  assert(typeof ctx.getCookie === 'function', 'ctx.getCookie must be a function');
  assert(typeof ctx.setCookie === 'function', 'ctx.getCookie must be a function');
  assert(typeof ctx.query === 'object', 'ctx.query must be an object');
